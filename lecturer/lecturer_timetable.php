...
// Fetch sessions for this lecturer for the current week
$sessions = [];
try {
    $stmt = $pdo->prepare("
        SELECT 
    ...
    ");
    $stmt->execute([$week_start, $week_end, $lecturer_id]);
...
<body>
    ...
    <main class="main-content">
            ...
            <section class="timetable-section">
                <div class="card">
                    <div class="timetable-container">
                        <div class="timetable-grid timetable-table">
                        <!-- Header Row -->
                                ...
                                <div class="timetable-row">
                                    ...
                                    <?php foreach ($days as $day): ?>
                                        <div class="schedule-cell" data-day="<?php echo $day['name']; ?>" data-time="<?php echo $time; ?>">
                                            ...
                                            // For lecturer, do not show add session option
                                            if (!$class_found) {
            ...
            <div>
                <!-- New 3-card Statistics for Lecturer -->
                <section class="lecturer-stats-cards">
                    <div class="lecturer-stats-grid">
                        <div class="lecturer-stat-card stat-sessions">
                            <div class="lecturer-stat-icon"><i class="fas fa-calendar-day"></i></div>
                            <div class="lecturer-stat-content">
                                <h3><?php echo count($sessions); ?></h3>
                                <p>Sessions This Week</p>
                            </div>
                        </div>
                        <div class="lecturer-stat-card stat-classes">
                            <div class="lecturer-stat-icon"><i class="fas fa-book"></i></div>
                            <div class="lecturer-stat-content">
                                <h3><?php echo count($unique_classes); ?></h3>
                                <p>Classes</p>
                            </div>
                        </div>
                        <div class="lecturer-stat-card stat-times">
                            <div class="lecturer-stat-icon"><i class="fas fa-clock"></i></div>
                            <div class="lecturer-stat-content">
                                <h3><?php echo count($time_slots); ?></h3>
                                <p>Time Slots</p>
                            </div>
                        </div>
                    </div>
