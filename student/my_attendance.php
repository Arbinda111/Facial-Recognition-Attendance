...
<head>
  ...
  <style>
    /* Extra visual polish */
    .dashboard-content { animation: fadeIn 0.7s; }
    ...
    .kpi-card:hover { box-shadow: 0 8px 32px rgba(108,143,245,0.12); }
    .attendance-table tr:hover td { background: #f0f6ff; }
  </style>
</head>
  ...
  <div class="dashboard">
    ...
    <aside class="sidebar">
      ...
      <nav>
        ...
        <a href="my_attendance.php" class="active">My Attendance</a>
